...
class Frame:
    ...
    def make_child_frame(self, formals, vals):
        ...
        if formals==nil:
            return child_frame
        first1,second1=formals.first,formals.rest
        first2,second2=vals.first,vals.rest
        child_frame.define(first1,first2)
        while second1!=nil:
            first1=second1.first
            first2=second2.first
            second1=second1.rest
            second2=second2.rest
            child_frame.define(first1,first2)
        return child_frame
