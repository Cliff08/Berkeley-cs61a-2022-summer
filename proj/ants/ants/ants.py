    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            if place.ant.is_container:
                if place.ant.ant_contained==None and self.is_container==False:
...
class Bee(Insect):
    ...
    def action(self, gamestate):
        ...
        if self.slow(0)(gamestate):
            destination=self.place
        elif self.scare(self.status_scare)(gamestate):
            if self.place.entrance.is_hive:
                destination=self.place
            else:
                destination=self.place.entrance  
            if self.status_scare>0:
                self.status_scare-=1     
        if self.blocked():
    ...
    def slow(self, length):
        ...
        # BEGIN Problem EC
        "*** YOUR CODE HERE ***"
        self.status_slow+=length
        def slow_flag(gamestate):
            if gamestate.time%2==0 or self.status_slow<=0:
                return False
            else:
                return True
        return slow_flag
    ...
    def scare(self, length):
        ...
        # BEGIN Problem EC
        "*** YOUR CODE HERE ***"
        self.status_scare=length
        def scare_flag(gamestate):
            if self.slow(0)(gamestate)==False and self.status_scare>0:
                return True
            else:
                return False
        return scare_flag
...
class ScaryThrower(ThrowerAnt):
    ...
    def throw_at(self, target):
        # BEGIN Problem EC
        "*** YOUR CODE HERE ***"
        if target and target not in ScaryThrower.scared_bees: # Can't scare a bee twice
            target.scare(2)
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self):
        ...
        while searching_place.is_hive!=True:
